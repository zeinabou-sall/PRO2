...
export interface ApiCardCard extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    coverColor: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#f72585'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiColumnColumn extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    color: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#b5179e'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    wipLimit: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
  };
}
...
export interface ApiLabelLabel extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    color: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'#D946EF'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
